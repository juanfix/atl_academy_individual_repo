...
import atl.academy.atl_academy_individual_repo.trivia.repository.CategoryRepository;
import atl.academy.atl_academy_individual_repo.trivia.entities.Category;
import atl.academy.atl_academy_individual_repo.trivia.entities.Question;
...
//        listCategories.add(new Category("Ciencia", "Preguntas relacionadas con diferentes ramas de la ciencia, descubrimientos y avances científicos."));
        ...
        listCategories.add(categoryRepository.findById(1L));
